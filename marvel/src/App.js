...
import './App.css';
import Marvel from './assets/components/Marvel.jsx';
...
let superJson = [{
  ...
  code: "batman",
  universe: "DC Comics",
  energy: "Интеллект, обширные познания, знания боевых искусств, ловкость",
  ...
  code: "superman",
  universe: "DC Comics",
  energy: "Непробиваемость, суперсила, полет, самоисцеление, суперзрение и суперслух, классный костюм",
  ...
  energy: "Высокий уровень интеллекта, широкие познания науки и техники, связь со всемирной паутиной, бронекостюмы",
  ...
  code: "spiderman",
  universe: "Marvel Comics",
  energy: "Сверхчеловеческие рефлексы, «паучье чутье», способность прилепляться к твердым поверхностям, производство паутины",
  ...
  code: "captainamerica",
  universe: "Marvel Comics",
  energy: "Сила, выносливость, бессмертие, быстрая регенерация, мастерство скрытности и боя",
  ...
  code: "thor",
  universe: "Marvel Comics",
  energy: "Все, что может бог, плюс молот Мьелнир",
  ...
  code: "hulk",
  universe: "Marvel Comics",
  energy: "Сверхчеловеческая сила искорость, выносливость, полет",
  ...
  code: "blackwidow",
  universe: "Marvel Comics",
  energy: "Пик человеческого физического потенциала, замедленное старение, знание многих языков",
  ...
  code: "deadpool",
  universe: "Marvel Comics",
  energy: "Высокий болевой порог, регенерация и бессмертие, сверхчеловеческая иммунная система",
...
function App() {
  return (
    <div className="App">
      {
        superJson.map((marvel) =>
        <Marvel name={marvel.name} universe={marvel.universe} image={marvel.image} energy={marvel.energy} detail={marvel.detail}></Marvel>
        )
      }
    </div>
  );
